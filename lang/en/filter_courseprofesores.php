...
/**
 * English language strings for the courseprofesores filter.
 *
...
$string['showdepartment_desc'] = 'Display profesor department information if available.';
$string['showinstitution'] = 'Show institution';
$string['showinstitution_desc'] = 'Display profesor institution information if available.';
$string['showmessagelink'] = 'Show message link';
