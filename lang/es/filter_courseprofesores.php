...
/**
 * Spanish language strings for the courseprofesores filter.
 *
...
$string['showdepartment_desc'] = 'Mostrar la información del departamento del profesor si está disponible.';
$string['showinstitution'] = 'Mostrar institución';
$string['showinstitution_desc'] = 'Mostrar la información de la institución del profesor si está disponible.';
$string['showmessagelink'] = 'Mostrar enlace de mensaje';
