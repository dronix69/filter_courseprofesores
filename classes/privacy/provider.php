...
/**
 * Privacy Subsystem implementation for filter_courseprofesores.
 *
 * This filter does not store any personal data. It only reads existing
 * user data to display course profesores.
 *
